...
(function($, window, document, undefined) {
    var $window = $(window);
    var isLG=document.body.offsetWidth>768;
                ...
                if (!this.loaded) {
                    ...
                    $("<img />")
                        .bind("load", function() {
                            ...
                            var original = $self.attr("lazy-" + settings.data_attribute+(isLG?'':'-mob'))||$self.attr("lazy-" + settings.data_attribute);
                            $self.hide();
                            if ($self.is("img")) {
                        ...
                        .attr("src", $self.attr("lazy-" + settings.data_attribute+(isLG?'':'-mob'))||$self.attr("lazy-" + settings.data_attribute));
                }
            });
